...
- Name: webautomation\shop.spec.ts >> Search >> should show no results message for unknown keyword
- Location: tests\webautomation\shop.spec.ts:67:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/search?q=xyznotfound
Call log:
  - navigating to "http://localhost:3001/search?q=xyznotfound", waiting until "load"
