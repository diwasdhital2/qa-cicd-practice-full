...
- Name: webautomation\shop.spec.ts >> Search >> should return results for a valid keyword
- Location: tests\webautomation\shop.spec.ts:62:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/search?q=headphones
Call log:
  - navigating to "http://localhost:3001/search?q=headphones", waiting until "load"
