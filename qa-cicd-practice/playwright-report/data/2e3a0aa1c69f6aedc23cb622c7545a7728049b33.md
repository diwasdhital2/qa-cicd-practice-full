...
- Name: webautomation\shop.spec.ts >> Products page >> should filter products by category
- Location: tests\webautomation\shop.spec.ts:34:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/products?category=Electronics
Call log:
  - navigating to "http://localhost:3001/products?category=Electronics", waiting until "load"
